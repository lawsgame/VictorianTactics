...
public class PathFinderTest : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            Vector3Int clickedCell = _battlefield.Map.WorldToCell(mousePosition);
            Debug.Log(string.Join(" <- ", Algorithm.GetShortestPath(_battlefield, _initGridPos, clickedCell, 99, 0)));
